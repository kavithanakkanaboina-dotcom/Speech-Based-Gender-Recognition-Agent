...
with open("Speech-Based Gender Recognition Agent.pkl", "rb") as file:
    model = pickle.load(file)

st.title("Speech-Based Gender Recognition Agent")

st.write("Enter the voice feature values below:")
...
if st.button("Predict Gender"):
    ...
    features = np.array([[meanfreq, sd, median, Q25, Q75, IQR,
                          skew, kurt, sp_ent, sfm, mode,
    ...
    if prediction == 0 or prediction == "female":
